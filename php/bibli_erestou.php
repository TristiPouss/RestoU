...
define ('BD_NAME', 'desaintgilles_erestou');
define ('BD_USER', 'desaintgilles_u');
define ('BD_PASS', 'desaintgilles_p');
...
//_______________________________________________________________
/**
 * Transforme un entier entre 1 et 12 en mois : 
 *
 * @param mois    le mois
 *
 * @return string
 */
function moisStr(int $mois) : string {
    switch($mois){
        case 1:
            return "janvier";
            break;
